...
10. <span id="n10"></span>Radio logs, *Chicago Daily Tribune*, *New York Times*, *Los Angeles Times*, and *Washington Post*, all Friday, September 1, 1939; and *Broadcasting*, September 1, 1939.<sup id="r17"><a href="#n17">17</a></sup> <a href="#r10">&#8617;</a>
...
17. <span id="n17"></span>Per CMOS 18, page numbers are omitted from newspaper citations throughout this paper. A newspaper's issue for a given day may appear in several editions in which items move or are dropped, so the masthead, city, date, and listing genre identify the item and the page number does not reliably do so. <a href="#r17">&#8617;</a>
17. <span id=\"n17\"></span>Per CMOS 18, page numbers are omitted from newspaper citations throughout this paper. A newspaper's issue for a given day may appear in several editions in which items move or are dropped, so the masthead, city, date, and listing genre identify the item and the page number does not reliably do so. <a href="#r17">&#8617;</a>
---
